...
const MODEL_PRICING_VERSION = "v2-openrouter-snapshot-2026-02-19";
const DEFAULT_MODEL_PRICING = [
  {
    id: "debug-local",
    patterns: [/modelbox[/_-]?debug[-_.\s]?model/i, /\bdebug[-_.\s]?model\b/i],
    inputPerMillion: 0,
    outputPerMillion: 0,
  ...
  {
    id: "anthropic-sonnet-4.5-4.6",
    patterns: [
      /claude[-_.\s]?sonnet[-_.\s]?4(?:[-_.\s]?5|\.5|[-_.\s]?6|\.6)/i,
      /claude[-_.\s]?4(?:[-_.\s]?5|\.5|[-_.\s]?6|\.6)[-_.\s]?sonnet/i,
      /claude[-_.\s]?sonnet[-_.\s]?4(?:[-_.\s]?5|\.5|[-_.\s]?6|\.6)[-_.\s]?thin/i,
    ],
    inputPerMillion: 3,
    outputPerMillion: 15,
  ...
  {
    id: "anthropic-opus-4.5-4.6",
    patterns: [
      /claude[-_.\s]?opus[-_.\s]?4(?:[-_.\s]?5|\.5|[-_.\s]?6|\.6)/i,
      /claude[-_.\s]?4(?:[-_.\s]?5|\.5|[-_.\s]?6|\.6)[-_.\s]?opus/i,
      /claude[-_.\s]?opus[-_.\s]?4(?:[-_.\s]?5|\.5|[-_.\s]?6|\.6)[-_.\s]?thin/i,
    ],
    inputPerMillion: 5,
    outputPerMillion: 25,
  ...
  },
  {
    ...
    patterns: [/gpt[-_.\s]?5(?:[._-]?2)?[-_.\s]?pro/i],
    inputPerMillion: 21,
  ...
  {
    id: "openai-gpt-5.2-series",
    patterns: [/\bgpt[-_.\s]?5(?:[._-]?2)(?:[-_.\s]?(?:chat|codex))?\b/i],
  ...
  },
  {
    ...
    patterns: [/\bgpt[-_.\s]?5(?:[._-]?3)[-_.\s]?codex(?:[-_.\s]?spark)?\b/i],
    inputPerMillion: 1.75,
    outputPerMillion: 14,
    cacheReadPerMillion: 0.175,
    cacheWritePerMillion: 0,
  ...
  {
    id: "openai-gpt-5-default",
    patterns: [/\bgpt[-_.\s]?5(?:[-_.\s]?(?:chat|codex))?\b/i],
  ...
  },
  {
    ...
    patterns: [/gemini[-_.\s]?3[-_.\s]?pro(?:[-_.\s]?(?:preview|high|low))?/i],
    inputPerMillion: 2,
    outputPerMillion: 12,
  ...
  },
  {
    ...
    patterns: [
      /gemini[-_.\s]?3[-_.\s]?flash(?:[-_.\s]?(?:preview|latest))?/i,
      /gemini[-_.\s]?flash[-_.\s]?latest/i,
    ],
    inputPerMillion: 0.5,
    outputPerMillion: 3,
    cacheReadPerMillion: 0.05,
    cacheWritePerMillion: 0.0833333333,
  },
  {
    id: "zai-glm-5",
    patterns: [/\bglm[-_.\s]?5\b/i],
    inputPerMillion: 0.3,
  ...
  },
  {
    ...
    patterns: [/kimi[-_.\s]?k2(?:[-_.\s]?5|\.5)/i],
  ...
  {
    id: "minimax-m2.5",
    patterns: [/minimax[-_.\s]?m2(?:[-_.\s]?5|\.5)/i],
    inputPerMillion: 0.3,
  ...
  {
    id: "minimax-m2.1",
    patterns: [/minimax[-_.\s]?m2(?:[-_.\s]?1|\.1)/i],
  ...
  {
    id: "qwen3-max",
    patterns: [/qwen[-_.\s]?3(?:[._-]?max|[._-]?max[-_.\s]?thinking)/i],
    inputPerMillion: 1.2,
    outputPerMillion: 6,
  ...
  {
    id: "qwen3.5-plus",
    patterns: [/qwen[-_.\s]?3\.?5[-_.\s]?plus/i],
    inputPerMillion: 0.4,
  ...
  {
    id: "qwen3.5-397b",
    patterns: [/qwen[-_.\s]?3\.?5[-_.\s]?397b/i],
  ...
  {
    id: "deepseek-chat",
    patterns: [/deepseek[-_.\s]?(chat|v3\.?1|v3\.?2)/i],
  ...
  },
  {
    ...
    patterns: [/deepseek[-_.\s]?(reasoner|r1)/i],
    inputPerMillion: 0.7,
